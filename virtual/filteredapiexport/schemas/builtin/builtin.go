...
// TODO: this could be handled via code generation.
func init() {
	...
	// TODO: Once we move fully to v1alpha2, we need to refactor this. For now its easier to operate
...
// workspace
// TODO: Once we move fully to v1alpha2, we need to refactor this.
var builtInAPIResourceSchemas map[apisv1alpha1.GroupResource]*apisv1alpha1.APIResourceSchema

// TODO: ideally this would not be public, but it is currently used
