...
import (
	...
	filteredapiexportoptions "github.com/kcp-dev/contrib-filteredapiexport-vw/internal/virtual/filteredapiexport/options"
...
type Options struct {
	...
	ShardName                string
	LocalShardKubeconfigFile string
	FrontProxyKubeconfigFile string
	Context                  string
	...
	FilteredAPIExportVirtualWorkspace filteredapiexportoptions.FilteredAPIExport
...
func NewOptions() *Options {
	opts := &Options{
		...
		FilteredAPIExportVirtualWorkspace: *filteredapiexportoptions.New(),
...
func (o *Options) AddFlags(flags *pflag.FlagSet) {
	...
	o.FilteredAPIExportVirtualWorkspace.AddFlags(flags, "filtered-apiexport-vw")

	flags.StringVar(&o.ShardName, "shard-name", o.ShardName, "Name of the shard this virtual workspace is related to")
	...
	flags.StringVar(&o.LocalShardKubeconfigFile, "local-shard-kubeconfig", o.LocalShardKubeconfigFile,
		"The kubeconfig file of the local shard.")
	_ = cobra.MarkFlagRequired(flags, "local-shard-kubeconfig")

	flags.StringVar(&o.FrontProxyKubeconfigFile, "front-proxy-kubeconfig", o.FrontProxyKubeconfigFile,
		"The kubeconfig file of the front proxy.")
	_ = cobra.MarkFlagRequired(flags, "front-proxy-kubeconfig")
...
func (o *Options) Validate() error {
	...
	errs = append(errs, o.FilteredAPIExportVirtualWorkspace.Validate()...)

	if len(o.ShardName) == 0 {
		errs = append(errs, fmt.Errorf("--shard-name is required"))
	}
	if len(o.ShardExternalURL) == 0 {
		errs = append(errs, fmt.Errorf(("--shard-external-url is required")))
	}

	if len(o.LocalShardKubeconfigFile) == 0 {
		errs = append(errs, fmt.Errorf("--local-shard-kubeconfig is required for this command"))
	}
