...
import (
	...
	"github.com/kcp-dev/contrib-filteredapiexport-vw/cmd/virtual-workspaces/options"
	"github.com/kcp-dev/contrib-filteredapiexport-vw/reconciler"
...
func Run(ctx context.Context, o *options.Options) error {
	...
	// create cache filteredapiexport client and informers
	...
	if err := r.InstallControllers(ctx, filteredAPIExportConfig); err != nil {
		return err
	}
	...
	r.InstallIndexers(filteredAPIExportInformers, wildcardKcpInformers.Apis().V1alpha2().APIExports())
