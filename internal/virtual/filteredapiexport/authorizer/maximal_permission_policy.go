...
type maximalPermissionAuthorizer struct {
	getFilteredAPIExportEndpointSlice func(clusterName, filteredAPIExportESName string) (*filteredvwv1alpha1.FilteredAPIExportEndpointSlice, error)
...
func NewMaximalPermissionAuthorizer(deepSARClient kcpkubernetesclientset.ClusterInterface, filteredAPIExportESInformer filteredvwinformers.FilteredAPIExportEndpointSliceClusterInformer, apiExportInformer apisv1alpha2informers.APIExportClusterInformer) authorizer.Authorizer {
