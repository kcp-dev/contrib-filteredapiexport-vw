...
import (
	...
	filteredvwlisters "github.com/kcp-dev/contrib-filteredapiexport-vw/sdk/client/listers/filteredvw/v1alpha1"
...
func NewAPIReconciler(
	...
	filteredAPIExportESInformer filteredvwinformers.FilteredAPIExportEndpointSliceClusterInformer,
	...
	c := &APIReconciler{
		...
		listFilteredAPIExportEndpointSlices: func(clusterName logicalcluster.Name) ([]*filteredvwv1alpha1.FilteredAPIExportEndpointSlice, error) {
	...
	_, _ = filteredAPIExportESInformer.Informer().AddEventHandler(cache.ResourceEventHandlerFuncs{
		AddFunc: func(obj interface{}) {
			c.enqueueFilteredAPIExportEndpointSlice(obj.(*filteredvwv1alpha1.FilteredAPIExportEndpointSlice), logger)
		},
...
type APIReconciler struct {
	...
	filteredAPIExportEndpointSliceLister  filteredvwlisters.FilteredAPIExportEndpointSliceClusterLister
...
func (c *APIReconciler) enqueueFilteredAPIExportEndpointSlice(filteredSlice *filteredvwv1alpha1.FilteredAPIExportEndpointSlice, logger logr.Logger) {
