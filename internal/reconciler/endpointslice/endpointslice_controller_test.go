...
var (
	testDefaultFilteredAPIExportEndpointSlice = &filteredvwv1alpha1.FilteredAPIExportEndpointSlice{
		...
		Spec: filteredvwv1alpha1.FilteredAPIExportEndpointSliceSpec{
			...
			ObjectSelector: filteredvwv1alpha1.FilteredAPIExportObjectSelector{
...
func TestReconcile(t *testing.T) {
	tests := map[string]struct {
		filteredAPIExportES *filteredvwv1alpha1.FilteredAPIExportEndpointSlice
		...
		"APIExportValid set to false when APIExport is missing": {
			...
			errorReason:           filteredvwv1alpha1.APIExportNotFoundReason,
		...
		"APIExportValid set to false if an internal error happens when fetching the APIExport": {
			...
			wantError:             true,
			errorReason:           filteredvwv1alpha1.InternalErrorReason,
			wantAPIExportNotValid: true,
		},
