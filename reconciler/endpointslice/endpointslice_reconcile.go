...
func (c *controller) reconcile(ctx context.Context, filteredAPIExportES *filteredapiexportv1alpha1.FilteredAPIExportEndpointSlice) error {
...
func (r *endpointsReconciler) reconcile(_ context.Context, filteredAPIExportES *filteredapiexportv1alpha1.FilteredAPIExportEndpointSlice) error {
	// Get APIExport
	...
	if err != nil {
		reason := filteredapiexportv1alpha1.InternalErrorReason
		if apierrors.IsNotFound(err) {
			...
			conditions.MarkFalse(
				filteredAPIExportES,
				filteredapiexportv1alpha1.APIExportValid,
				filteredapiexportv1alpha1.APIExportNotFoundReason,
	...
	conditions.MarkTrue(filteredAPIExportES, filteredapiexportv1alpha1.APIExportValid)
