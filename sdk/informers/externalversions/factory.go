...
import (
	...
	filteredapiexportinformers "github.com/kcp-dev/contrib-filteredapiexport-vw/sdk/informers/externalversions/filteredapiexport"
...
type SharedInformerFactory interface {
	...
	Filteredapiexport() filteredapiexportinformers.ClusterInterface
}

func (f *sharedInformerFactory) Filteredapiexport() filteredapiexportinformers.ClusterInterface {
	return filteredapiexportinformers.New(f, f.tweakListOptions)
}
...
type SharedScopedInformerFactory interface {
	...
	Filteredapiexport() filteredapiexportinformers.Interface
}

func (f *sharedScopedInformerFactory) Filteredapiexport() filteredapiexportinformers.Interface {
	return filteredapiexportinformers.NewScoped(f, f.namespace, f.tweakListOptions)
}
