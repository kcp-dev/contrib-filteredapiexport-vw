...
// apply.
func FilteredAPIExportEndpointSliceStatus() *FilteredAPIExportEndpointSliceStatusApplyConfiguration {
	return &FilteredAPIExportEndpointSliceStatusApplyConfiguration{}
}
