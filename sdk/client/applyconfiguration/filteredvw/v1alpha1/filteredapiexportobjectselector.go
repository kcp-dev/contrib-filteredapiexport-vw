...
// FilteredAPIExportObjectSelectorApplyConfiguration represents a declarative configuration of the FilteredAPIExportObjectSelector type for use
// with apply.
type FilteredAPIExportObjectSelectorApplyConfiguration struct {
	v1.LabelSelectorApplyConfiguration `json:",inline"`
}

// FilteredAPIExportObjectSelectorApplyConfiguration constructs a declarative configuration of the FilteredAPIExportObjectSelector type for use with
// apply.
func FilteredAPIExportObjectSelector() *FilteredAPIExportObjectSelectorApplyConfiguration {
	return &FilteredAPIExportObjectSelectorApplyConfiguration{}
}
...
func (b *FilteredAPIExportObjectSelectorApplyConfiguration) WithMatchLabels(entries map[string]string) *FilteredAPIExportObjectSelectorApplyConfiguration {
...
func (b *FilteredAPIExportObjectSelectorApplyConfiguration) WithMatchExpressions(values ...*v1.LabelSelectorRequirementApplyConfiguration) *FilteredAPIExportObjectSelectorApplyConfiguration {
	for i := range values {
		if values[i] == nil {
