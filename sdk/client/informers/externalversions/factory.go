...
import (
	...
	filteredvwinformers "github.com/kcp-dev/contrib-filteredapiexport-vw/sdk/client/informers/externalversions/filteredvw"
...
type SharedInformerFactory interface {
	...
	Filteredvw() filteredvwinformers.ClusterInterface
}

func (f *sharedInformerFactory) Filteredvw() filteredvwinformers.ClusterInterface {
	return filteredvwinformers.New(f, f.tweakListOptions)
}
...
type SharedScopedInformerFactory interface {
	...
	Filteredvw() filteredvwinformers.Interface
}

func (f *sharedScopedInformerFactory) Filteredvw() filteredvwinformers.Interface {
	return filteredvwinformers.NewScoped(f, f.namespace, f.tweakListOptions)
}
