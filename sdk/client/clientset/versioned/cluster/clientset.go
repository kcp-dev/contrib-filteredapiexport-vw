...
import (
	...
	filteredvwv1alpha1 "github.com/kcp-dev/contrib-filteredapiexport-vw/sdk/client/clientset/versioned/cluster/typed/filteredvw/v1alpha1"
)

type ClusterInterface interface {
	Cluster(logicalcluster.Path) client.Interface
	Discovery() discovery.DiscoveryInterface
	FilteredvwV1alpha1() filteredvwv1alpha1.FilteredvwV1alpha1ClusterInterface
}
...
type ClusterClientset struct {
	*discovery.DiscoveryClient
	...
	filteredvwV1alpha1 *filteredvwv1alpha1.FilteredvwV1alpha1ClusterClient
}
...
func (c *ClusterClientset) FilteredvwV1alpha1() filteredvwv1alpha1.FilteredvwV1alpha1ClusterInterface {
	return c.filteredvwV1alpha1
}
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*ClusterClientset, error) {
	...
	var err error
	cs.filteredvwV1alpha1, err = filteredvwv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
