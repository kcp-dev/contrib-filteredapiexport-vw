...
import (
	...
	filteredapiexportv1alpha1 "github.com/kcp-dev/contrib-filteredapiexport-vw/sdk/clientset/versioned/cluster/typed/filteredapiexport/v1alpha1"
)

type ClusterInterface interface {
	Cluster(logicalcluster.Path) client.Interface
	Discovery() discovery.DiscoveryInterface
	FilteredapiexportV1alpha1() filteredapiexportv1alpha1.FilteredapiexportV1alpha1ClusterInterface
}
...
type ClusterClientset struct {
	*discovery.DiscoveryClient
	...
	filteredapiexportV1alpha1 *filteredapiexportv1alpha1.FilteredapiexportV1alpha1ClusterClient
}
...
func (c *ClusterClientset) FilteredapiexportV1alpha1() filteredapiexportv1alpha1.FilteredapiexportV1alpha1ClusterInterface {
	return c.filteredapiexportV1alpha1
}
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*ClusterClientset, error) {
	...
	var err error
	cs.filteredapiexportV1alpha1, err = filteredapiexportv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
